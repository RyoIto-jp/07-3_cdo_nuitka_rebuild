            ...
            <section className={cls.plot}>
              ...
              {/* <ResponsiveContainer width="100%" height="100px"> */}
                <PieChart width={200} height={100}>
                  <Pie data={[{ name: "Group", value: 10 }]} startAngle={180} endAngle={180-9 * row.Count} dataKey="value" cx="50%" cy="50%" outerRadius={60} innerRadius={50}  fill="#30ca9d"  label />
                  <Pie data={[{ name: "First", value: 15 },{ name: "Second", value: 15 }]} startAngle={180} endAngle={0} dataKey="value" cx="50%" cy="50%"  outerRadius={40} fill="#ccffff90" />
                  <Tooltip/>
                </PieChart>
              {/* </ResponsiveContainer> */}
